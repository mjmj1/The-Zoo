...
Shader "Cartoon FX/Remaster/Curved Particle Screen Distortion"
{
    Properties
    {
    ...
    Category
    {
        ...
        Subshader
        {
            Pass
            {
                ...
                #include "Assets/Resources/JMO Assets/Cartoon FX Remaster/CFXR Assets/Shaders/CFXR_PASSES.cginc""
