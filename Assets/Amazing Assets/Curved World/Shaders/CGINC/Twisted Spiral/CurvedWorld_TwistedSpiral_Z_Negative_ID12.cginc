...
void CurvedWorld_TwistedSpiral_Z_Negative_ID12(inout float4 vertexOS, inout float3 normalOS,
                                               float4 tangent)
{
    CurvedWorld_TwistedSpiral_Z_Negative(vertexOS,
                                         normalOS,
...
void CurvedWorld_TwistedSpiral_Z_Negative_ID12(inout float3 vertexOS, inout float3 normalOS,
                                               float4 tangent)
{
    float4 vertex = float4(vertexOS, 1);
...
void CurvedWorld_TwistedSpiral_Z_Negative_ID12_float(float3 vertexOS, float3 normalOS,
...
void CurvedWorld_TwistedSpiral_Z_Negative_ID12_half(half3 vertexOS, half3 normalOS, half4 tangent,
