...
void CurvedWorld_SpiralVerticalRolloff_X_ID27(inout float4 vertexOS, inout float3 normalOS,
                                              float4 tangent)
{
    CurvedWorld_SpiralVerticalRolloff_X(vertexOS,
                                        normalOS,
...
void CurvedWorld_SpiralVerticalRolloff_X_ID27(inout float3 vertexOS, inout float3 normalOS,
                                              float4 tangent)
{
    float4 vertex = float4(vertexOS, 1);
...
void CurvedWorld_SpiralVerticalRolloff_X_ID27_float(float3 vertexOS, float3 normalOS,
...
void CurvedWorld_SpiralVerticalRolloff_X_ID27_half(half3 vertexOS, half3 normalOS, half4 tangent,
